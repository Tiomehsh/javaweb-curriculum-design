...
<head>
    ...
    <title>公务预约管理 - 校园通行码预约管理系统</title>
...
<body>
    <!-- 隐藏的input字段，用于将服务器端变量传递给JavaScript -->
    <input type="hidden" id="is-department-admin" value="${admin.role == 'DEPARTMENT_ADMIN'}">
    <input type="hidden" id="is-system-admin" value="${admin.role == 'SYSTEM_ADMIN'}">
    <input type="hidden" id="is-reception-admin" value="${admin.role == 'RECEPTION_ADMIN'}">
    <input type="hidden" id="department-id" value="${admin.deptId}">
        ...
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <div class="nav-section">
                    ...
                    <a href="official_appointments.jsp" class="nav-item active">
                        🏢 公务预约管理
                    </a>
                    </c:if>
                </div>
    ...
    <div id="appointment-modal" class="modal">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button class="btn" onclick="closeModal('appointment-modal')">关闭</button>
            </div>
        </div>
    </div>
    ...
    <script src="${pageContext.request.contextPath}/js/official_appointments.js"></script>
</body>
</html>
