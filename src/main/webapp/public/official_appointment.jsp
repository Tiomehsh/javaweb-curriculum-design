...
<body>
    <div class="main-container">
        ...
        <div class="step-indicator">
            ...
            <div class="step" data-step="2">
                ...
                <div class="step-label">单位信息</div>
                <div class="step-line"></div>
            </div>
            <div class="step" data-step="3">
                <div class="step-number">3</div>
                <div class="step-label">访问详情</div>
                <div class="step-line"></div>
            </div>
        ...
        <form id="appointmentForm">
            ...
            <div class="form-step active" data-step="1">
                ...
                <div class="form-group">
                    <label for="name">联系人姓名<span class="required">*</span></label>
                ...
                <div class="form-group">
                    <label for="officialTitle">职务<span class="required">*</span></label>
                    <input type="text" id="officialTitle" name="officialTitle" class="form-control" required>
                    <div class="error-message"></div>
                </div>
            </div>
            ...
            <div class="form-step" data-step="2">
                ...
                <div class="form-group">
                    <label for="visitDept">访问部门<span class="required">*</span></label>
                    <select id="visitDept" name="visitDept" class="form-control" required>
                ...
                <div class="form-group">
                    <label for="visitContact">接待人</label>
                    <input type="text" id="visitContact" name="visitContact" class="form-control" placeholder="请输入接待人姓名（可空）">
                    <div class="error-message"></div>
                </div>
                
                <div class="form-group">
                    <label for="purpose">来访目的<span class="required">*</span></label>
            ...
            <div class="form-step" data-step="3">
                ...
                <div class="form-group">
                    <label for="visitTime">访问时间<span class="required">*</span></label>
                    <input type="datetime-local" id="visitTime" name="visitTime" class="form-control" required min="">
                    <div class="error-message"></div>
                </div>
                
                <div class="form-group">
                    <label for="visitors">访问人数<span class="required">*</span></label>
                    <input type="number" id="visitors" name="visitors" class="form-control" required min="1" max="20">
                    <div class="error-message"></div>
                </div>
    ...
    <div id="agreement-modal" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background-color: rgba(0,0,0,0.5); z-index: 1000;">
        <div style="background-color: white; width: 80%; max-width: 600px; margin: 100px auto; padding: 20px; border-radius: 8px; max-height: 80vh; overflow-y: auto;">
            ...
            <div>
                <p style="margin-bottom: 10px;">1. 请如实填写个人和单位信息，身份证号和手机号将用于身份验证和通知。</p>
                <p style="margin-bottom: 10px;">2. 公务来访需经过被访问部门审批，请提前3个工作日预约。</p>
                <p style="margin-bottom: 10px;">3. 预约成功后，请在预约时间前到达指定校区的接待中心进行签到。</p>
                <p style="margin-bottom: 10px;">4. 访问人数限制为1-20人，如需大型团体访问，请提前联系管理员。</p>
                <p style="margin-bottom: 10px;">5. 预约成功后如需取消，请至少提前24小时取消，否则将记入信用记录。</p>
                <p style="margin-bottom: 10px;">6. 校园内请遵守各项规章制度，不得影响正常教学秩序。</p>
                <p style="margin-bottom: 10px;">7. 被访问部门有权对不符合规定的来访拒绝接待。</p>
    ...
    <script src="${pageContext.request.contextPath}/js/official_appointment.js"></script>
</body>
</html>